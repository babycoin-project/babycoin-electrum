...
<div>
    ...
    <q-modal minimized ref="aboutModal">
        <div class="about-modal">
            ...
            <img class="q-mb-md" src="statics/babycoin.svg" height="42" />

            <p class="q-my-sm">Wallet Version: v{{version}}</p>
            <p class="q-my-sm">Daemon Version: v{{daemonVersion}}</p>

            <p class="q-my-sm">Copyright (c) 2021-2022 BabyCoin Project</p>
            ...
            <div class="q-mt-md q-mb-lg external-links">
                <p>
                    <a @click="openExternal('http://babycoin.dev/')" href="#">BabyCoin Project Official Website</a>
                </p>
                <p>
                    <a @click="openExternal('https://github.com/babycoin-project/babycoin-electrum')" href="#">BabyCoin Electron Github Source</a>
                </p>
            </div>

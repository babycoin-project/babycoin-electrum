...
export class Backend {
    ...
    init() {
	    ...
	    this.config_dir = "C:\\ProgramData\\babycoin";
	    this.wallet_dir = `${os.homedir()}\\Documents\\BabyCoin`
        } else {
            this.config_dir = path.join(os.homedir(), ".babycoin");
            this.wallet_dir = path.join(os.homedir(), "BabyCoin")
        }
        ...
        fs.readFile(this.config_file, "utf8", (err, data) => {
            ...
            this.daemon.checkVersion().then((version) => {
                ...
                if(version) {
                    ...
                    this.send("show_notification", {type: "warning", textColor: "black", message: "Warning: babycoind not found, using remote node", timeout: 2000})
                }
